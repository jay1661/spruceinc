(function ($) {
    ...
    function carafityquantity() {

        var $quantityBoxes = $('.quantity:not(.buttons_added):not(.hidden)').find('.qty:not([type="hidden"])');
    ...
    $(document).on('woosq_loaded qv_loader_stop updated_wc_div carafity-products-loaded',function () {
        carafityquantity();
    });
