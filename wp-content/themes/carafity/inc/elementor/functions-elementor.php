...
if ( ! function_exists( 'carafity_elementor_parse_text_editor' ) ) {
	function carafity_elementor_parse_text_editor( $content, $obj ) {
...
if ( ! function_exists( 'carafity_elementor_get_strftime' ) ) {
	function carafity_elementor_get_strftime( $instance, $obj ) {
		$string = '';
