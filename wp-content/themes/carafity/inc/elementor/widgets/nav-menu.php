...
class Carafity_Elementor_Nav_Menu extends Elementor\Widget_Base {

    protected $nav_menu_index = 1;

    public function get_name() {
        return 'carafity-nav-menu';
    }

    public function get_title() {
        return esc_html__('Carafity Nav Menu', 'carafity');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'style',
            [
                'label'   => esc_html__('Stule', 'carafity'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    ''       => esc_html__('Desktop', 'carafity'),
                    'mobile' => esc_html__('Mobile', 'carafity'),
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography Menu', 'carafity'),
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label'    => esc_html__('Typography Sub Menu', 'carafity'),
        ...
        $this->add_control(
            'menu_title_color',
            [
                'label'     => esc_html__('Color Menu', 'carafity'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Sub Menu', 'carafity'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'separator_color',
            [
                'label'     => esc_html__('Color Separator', 'carafity'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'sub_menu_color',
            [
                'label'     => esc_html__('Background Dropdown', 'carafity'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Item', 'carafity'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->start_controls_tab(
            'tab_nav_menu_action',
            [
                'label' => esc_html__('Active', 'carafity'),
            ]
        );
        $this->add_control(
...
$widgets_manager->register(new Carafity_Elementor_Nav_Menu());
