...
if (!carafity_is_mailchimp_activated()) {
    return;
}
...
class Carafity_Elementor_Mailchimp extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'carafity-mailchimp';
    }

    public function get_title()
    {
        return esc_html__('MailChimp Sign-Up Form', 'carafity');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Input', 'carafity'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Placeholder', 'carafity'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab(
            'tab_input_focus',
            [
                'label' => esc_html__('Focus', 'carafity'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Border Color hover', 'carafity'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Carafity_Elementor_Mailchimp());
