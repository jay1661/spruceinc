...
class Carafity_Elementor_Vertiacl_Menu extends Elementor\Widget_Base
{
    ...
    {
        return 'carafity-vertical-menu';
    }

    public function get_title()
    {
        return esc_html__('Carafity Vertical Menu', 'carafity');
    }
    ...
    protected function register_controls()
    {
        ...
        if (!empty($menus)) {
            $this->add_control(
                'menu',
                [
                    'label' => esc_html__('Menu', 'carafity'),
                    'type' => Controls_Manager::SELECT,
                    'options' => $menus,
                    'default' => array_keys($menus)[0],
                    'save_default' => true,
                    'separator' => 'after',
                    'description' => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'carafity'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
                ...
                [
                    ...
                    'raw' => '<strong>' . esc_html__('There are no menus in your site.', 'carafity') . '</strong><br>' . sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'carafity'), admin_url('nav-menus.php?action=edit&menu=0')),
                    'separator' => 'after',
        ...
        $this->add_control(
            'nav_vertiacl_layout',
            [
                'label' => esc_html__('Menu Layout', 'carafity'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'style-1' => esc_html__('Layout 1', 'carafity'),
                    'style-2' => esc_html__('Layout 2', 'carafity'),
                ],
                'default' => 'style-1',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation .vertical-navigation-header .carafity-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Icon Hover', 'carafity'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation:hover .vertical-navigation-header .carafity-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sub Menu', 'carafity'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Active', 'carafity'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Color Hover', 'carafity'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render()
    {
        ...
        <div <?php $this->print_render_attribute_string('wrapper'); ?>>
            <nav class="vertical-navigation" aria-label="<?php esc_attr_e('Vertiacl Navigation', 'carafity'); ?>">
...
$widgets_manager->register(new Carafity_Elementor_Vertiacl_Menu());
