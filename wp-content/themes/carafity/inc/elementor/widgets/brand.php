 ...
 * @since 1.0.0
 */
class Carafity_Elementor_Brand extends Carafity_Base_Widgets_Swiper {
    ...
    public function get_title() {
        return esc_html__('Brands', 'carafity');
    }
    ...
    public function get_script_depends() {
        return ['carafity-elementor-brand', 'carafity-elementor-swiper'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => esc_html__('Brands', 'carafity'),
            ]
        );
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'carafity'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'carafity'),
                'placeholder' => esc_html__('Brand Name', 'carafity'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_responsive_control(
            'brand_source',
            [
                'label'   => esc_html__('Brand Source', 'carafity'),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'default' => 'image',
                'options' => [
                    'image' => esc_html__('Image', 'carafity'),
                    'icon'  => esc_html__('Icon', 'carafity')
                ],
            ]
        );
        ...
        $repeater->add_control(
            'image_overlay',
            [
                'label'   => esc_html__('Image Background', 'carafity'),
                'type'    => Controls_Manager::MEDIA,
                'selectors' => [
        ...
        $this->start_controls_section(
            'style_brand_wrapper',
            [
                'label' => esc_html__('Brand Item', 'carafity'),
        ...
        $this->add_control(
            'background_overlay',
            [
                'label'     => esc_html__('Background Overlay', 'carafity'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .elementor-brand-item:hover .elementor-animation-hover-icon i'                                                     => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elementor-brand-item:hover .elementor-animation-hover-icon svg,{{WRAPPER}} .elementor-brand-item:hover .elementor-animation-hover-icon svg path' => 'fill: {{VALUE}};',
                ],
            ]
        );
...
$widgets_manager->register(new Carafity_Elementor_Brand());
