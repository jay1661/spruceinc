<?php
/**
 * Carafity WooCommerce Adjacent Products Class
 *
 * @package  carafity
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Carafity_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Carafity WooCommerce Adjacent Products Class
	 */
	class Carafity_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'carafity_woocommerce_adjacent_query_args', $args ) );
