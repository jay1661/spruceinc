<?php
/**
 * Carafity_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Carafity_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Carafity_Product_Brand_List_Walker', false)) :

	class Carafity_Product_Brand_List_Walker extends Walker {
